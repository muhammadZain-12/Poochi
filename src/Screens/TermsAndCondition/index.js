                        ...
                        <View style={styles.modalView}>
                            {/* <ScrollView style={{ marginBottom: 0, marginRight: 10, width: "100%" }}  >
                                ...
                                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    Welcome to Poochie!
                                    These terms and conditions outline the rules and regulations for the use of Poochie platforms..
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    By downloading or using Poochie app or Poochie Driver app, these terms will automatically apply to you – you should make sure therefore that you read them carefully before using our app. You’re not allowed to copy or modify any part of the app, or our trademarks in any way. You’re not allowed to attempt to extract the source code of the app, and you also shouldn’t try to translate the app into other languages or make derivative versions. The app itself, and all the trademarks, copyright, database rights, and other intellectual property rights related to it belong to XOX Rides Inc.and or XOX Rides Inc. DBA Poochie app and or Poochie.    <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    </Text>
                                    XOX Rides Inc. is committed to ensuring that the app is as useful and efficient as possible. For those reasons, we reserve the right to make changes to the app or to charge for its services, at any time and for any reason. We will never charge you for the app or its services without making it very clear to you exactly what you’re paying for.
                                </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    You agree to comply with and be bound by these Terms & Conditions (the "Agreement"). If you do not agree to these terms, please do not use the App.      </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company’s terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services, in accordance with and subject to, prevailing laws of California. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to the same.   </Text>

                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-Bold", marginTop: 10, marginHorizontal: 20 }} >
                                    Description of Services
                                </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginTop: 10, marginHorizontal: 20 }} >
                                    The Poochie App provides a platform that connects pet owners ("Users") with pet transportation service providers ("Drivers") and Pet Walkers, specifically dog walkers. Users can request transportation services or pet walks for their pets using the App, and Drivers can accept and fulfill those requests at their sole discretion. Poochie does not provide pet care services.. Poochie app is a neutral platform for Pet Owners and Service Providers.. Poochie is not a Service Provider and, except for emergency phone or help support through our platform app and or website. </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    B. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            Users are responsible for maintaining the confidentiality of their account credentials and for all activities that occur under their account                                        </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-Bold", marginTop: 10, marginHorizontal: 20 }} >
                                    This Agreement contains an arbitration provision enforceable by the parties. Please take your time and seek the necessary help to understand the consequences of entering into this Agreement.    </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    1)
                                    You are entitled to post the Comments on our App and have all necessary licenses and consents to do so;   </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    2)
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    3)
                                    The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >

                                    4)
                                    The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity. </Text>


                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    You hereby grant Poochie a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.  </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    ...
                                    1)
                                    Except as expressly permitted, you may not reproduce, modify, create derivative works from, distribute, license, lease, sell, resell, transfer, publicly display, perform, transfer or otherwise use the Service to stream, broadcast or otherwise exploit content created by Pucci.  </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >


                                    2)
                                    Unless permitted by law, you may not decompile, reverse engineer or disassemble the Services.      </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Ownership:
                                    ...
                                    <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                        The Services and all rights therein are and will remain the property of Poochie. Neither these Terms nor your use of the Services transfers or grants you any rights: (i) in or related to the Services, except for the limited license granted above; (ii) to use or reference Poochie in any manner company names, logos, product and service names, trademarks or service marks.
                                    </Text>
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    A. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >User Accounts:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            In order to use most features of the Services, you must register and maintain an active individual user Services account ("Account"). To obtain an Account, you must be 18 years of age or older, or the legal age of majority (other than 18) in your jurisdiction, unless otherwise permitted by a particular Service. Account registration requires you to provide Poochie with certain personal information, such as your name, address, mobile phone number, and age, and at least one valid payment method supported by Poochie. You agree to maintain accurate, complete and current information in your account. If you fail to maintain accurate, complete, and current account information, including providing an invalid or expired payment method, you may not access or use the Services.
                                        </Text>
                                    </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                        ...
                                        e. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >You represent and warrant that:
                                            ...
                                            <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                                (i) you are the sole and exclusive owner of all User Content or you have all rights, licenses, consents and releases that are necessary to grant to Poochie the license to the User Content as described above; (ii) User Content that you submit, upload, publish or otherwise Neither the provision of such User Content nor Poochie's use of the User Content as permitted by this Agreement will infringe, misappropriate or violate any third party's intellectual property or proprietary rights, or violate any right of publicity or privacy, or result in the violation of any applicable laws or regulations.
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    f. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Network Access and Devices:
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    f. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Feedback:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            After you have received Services or goods obtained through the service providers of Poochie, you will have the opportunity via email to rate your experience and leave additional feedback.
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    g. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Application of Payments:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            Poochie may use the proceeds of any Charges for any purpose, subject to any payment obligations it has to its service providers.
                                        </Text>
                                    </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    h. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Tips:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            Poochie does not designate any portion of your payment as a tip or gratuity to service providers. You understand and agree that, while you are free to provide additional payment as a gratuity to service providers who provide you pet transportation or pet walking services, you are under no obligation to do so. Gratuities are voluntary.
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    i. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Repair Cleaning or Lost and Found Fees:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            You shall be responsible for the cost of repair for damage to, or necessary cleaning of service provider vehicles and property resulting from use of pet transportation services under your Account in excess of normal “wear and tear” (“Repair or Cleaning”). In the event that a Repair or Cleaning request from the service provider is verified by Poochie, Poochie will Charge your Account for the reasonable cost of such Repair or Cleaning using your payment method designated in your Account.
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    Your Pets:  You hereby represent, represent and warrant that with respect to your pet using the Transportation Service or Walking Service:
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    Service Providers have the sole and absolute discretion to reject or refuse any pet transportation services or pet walking service that you may request, even at the point of pickup, when:  </Text>


                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >


                                    1)  the physical condition or temperament of the pet prevents timely delivery, prevents safe transportation or pet walk or endangers the security of the pet;
                                </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    ...
                                    3)  transportation or pet walk would be unlawful.
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    ...
                                    1)  If a Service Provider or Poochie reaches you with a request to authorize veterinary care for your pet and you refuse, you are solely responsible for the consequences to your Pet(s).
                                </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >


                                    2)
                                    If you cannot be reached to authorize care, and your pet needs immediate veterinary care in the estimation and discretion of Poochie or the Service Providor, you hereby authorize the service providor and/or Poochie to obtain and authorize veterinary care for your pet. You are solely responsible for the costs of any such veterinary treatment for your pet(s); and, you consent to and authorize Poochie to charge any of your payment methods for such costs.
                                </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >


                                    3)
                                    Liability to Poochie or Service Providers. Whether or not you can be reached, you waive, release and promise never to assert any claims or causes of action arising from seeking veterinary care or failure to seek such care against Poochie and Service Providor, and their predecessors, successors or past or present subsidiaries, stockholders, directors, officers, employees, consultants, attorneys, agents, or assigns with respect to any matter, including without limitation any claims of negligence, emotional distress, fraud, breach of contract, or breach of the covenant of good faith and fair dealing.
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our App and the use of this website. Nothing in this disclaimer will:    </Text>
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                    The arbitration shall be heard by one arbitrator (the “Arbitrator”) selected in accordance with the CPR Rules. The Arbitrator shall be an attorney with experience in the law underlying the dispute.  </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    ...
                                    f)
                                    Subject to the discretion of the Arbitrator or agreement of the Parties, any person having a direct interest in the arbitration may attend the arbitration hearing. The Arbitrator may exclude any non-party from any part of the hearing.
                                    <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    d. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Electronic Signatures:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            The provisions of The Ca. Uniform Electronic Transaction Act (UETA) Electronic Transactions Act and the Federal Electronic Signatures in Global and National Commerce Act (ESIGN) apply; and signatures and assent rendered under such acts shall be valid for all purposes.
                                        </Text>
                                    </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    e. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Costs:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            Should either Party seek legal recourse to have the other Party comply with and/or fulfill any of its legal obligations under this Agreement, the prevailing Party shall be entitled to recover all reasonable attorney fees, expert fees and all costs incurred in connection therewith.
                                        </Text>
                                    </Text>
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    f. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Courts:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            Actions seeking judicial relief may be brought only before federal or state courts having jurisdiction in Los Angeles County Court and each Party irrevocably submits to personal jurisdiction and waives any objection to venue in such courts. This provision does not negate mandatory arbitration.
                                        </Text>
                                    </Text>
                                </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                                    ...
                                    <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Assignment:
                                        ...
                                        <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                                            You may not assign this Agreement without Poochie’s prior written approval. Poochie may assign this Agreement without your consent to:
                                        </Text>
                                ...
                                <Text style={{ color: Colors.black, fontSize: 12, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                                    ...
                                    a successor by merger. Any purported assignment in violation of this section shall be void. No joint venture, partnership, employment, or agency relationship exists between you, Poochie or Service providers as a result of this Agreement or use of the Services.
