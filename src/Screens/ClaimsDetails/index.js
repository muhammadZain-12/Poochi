...
function ClaimDetails({ route, navigation }) {
    ...
    allData = allData && allData.length > 0 && allData.filter((e, i) => e.damagesClaim)
    monthlyData = monthlyData && monthlyData.length > 0 && monthlyData.filter((e, i) => e.damagesClaim)
    todayData = todayData && todayData.length > 0 && todayData.filter((e, i) => e.damagesClaim)
                ...
                <View>
                    <TouchableOpacity
                        ...
                        <Text
                            ...
                            Claim Amount:{' '}
                            <Text style={{ color: "#080808", fontFamily: "Poppins-Medium" }}> ${item.damagesClaim} </Text>
                        </Text>
            ...
            <ScrollView>
                ...
                {(allWalletData && allData.length == 0) ||
                    ...
                    <View
                        ...
                        <Text style={{ fontSize: 32, color: Colors.black }}>No Claims</Text>
                    </View>
                ) : (
                    <View>
                        <FlatList
