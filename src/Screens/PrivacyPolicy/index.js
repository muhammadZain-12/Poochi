    ...
    return (
        <View style={{ flex: 1, backgroundColor: Colors.white }} >
            ...
            <ScrollView style={{ marginBottom: 20 }}  >
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service. At XOX Rides Inc. and/or dba Poochie App and Poochie, our mission is to make people's lives easier through pet transportation services and provide a platform to help you transport your pets from point A to point B. To do this, we need to collect, use and disclose some of your personal information.     </Text>
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    B. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Driver Information:
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    C. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Customer:
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    D. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Drivers:
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    E. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Usage Information:
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    F. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Ratings and Feedback:

                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            When you rate and provide feedback to a customer or driver, we collect all the information you provide in the feedback. communicate. If you contact us or we contact you, we will collect any information you provide, including the content of any messages or attachments you send us. </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    Please understand that your contact number is accessible to our drivers when you book a ride or dog walk to facilitate communication. We use your given contact number for conversations between our drivers and customers when you book services. Note that we utilize third-party services for driver-customer chat communications.Poochie Analog does not use third parties to facilitate communications. Poochie Customer Service facilitates simulated Poochie communication between customers and drivers.
                </Text>
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-Bold", marginTop: 10, marginHorizontal: 20 }} >
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    A. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Providing Services:
                        ...
                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            We use your information to provide pet transportation services, including matching you with drivers and facilitating the transportation of your pets.    </Text>
                    </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    C. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Improvement:
                        ...
                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            We use collected data to improve our app and services, analyze user behavior, and enhance user experience. </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    We are constantly working to improve your experience and provide you with new and useful features. For this purpose, we use your personal data to:    </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    Respond to legal processes and requests. From time to time, laws, government agencies or other regulatory bodies impose requirements and obligations on the services we wish to provide. In such cases, we may use your personal information to respond to these requests or obligations.</Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    A. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Customers and Drivers:
                        ...
                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            Customer Information Shared with Drivers, When we receive a pet ride request or pet walk request, we share with the driver the scheduled pickup time and date, pickup location, destination, customer name, pet name and information, ratings, telephone number and we may also share customer demographics (e.g. Approximate number of trips) and number of years as a customer) and the information the customer includes in their customer and pets profile. We may also communicate customer ratings and feedback to drivers on a weekly basis. (When we share reviews and feedback with drivers, we remove the customer identification associated with the reviews and feedback, but drivers may be able to identify the customer who provided the review or feedback.)   </Text>
                    </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    C. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Referral Programs:
                        ...
                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            If referral program is available, When you refer someone to the Poochie Platform, we let them know that you initiated the referral. If another user refers to you, we may share information about your use of the Poochie Platform with that user. For example, referral sources may receive bonuses when you join the Poochie platform.  </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    Depending on whether you are a customer or a driver, Poochie may share the following categories of your personal information for business purposes in order to provide you with the various features and services of the Poochie Platform:   </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginTop: 10, marginHorizontal: 20 }} >
                    We want to inform users of this Service that these third parties have access to their Personal Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or use the information for any other purpose.    </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold", marginTop: 10, marginHorizontal: 40 }} >
                    ...
                    B. <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Legal Compliance:
                        ...
                        <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                            We may disclose your information to comply with legal obligations, such as responding to court orders or government requests.  </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                    We share these categories of personal information with our service providers for the following business purposes:   </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                    ...
                    2)
                    Information about your participation in third-party programs that provide insurance coverage and financial instruments, such as: B. Insurance, payment, transaction and fraud detection information;    </Text>
                <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20, marginLeft: 40 }} >
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >Cookie Tracking:
                    ...
                    <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                        You can modify your cookie settings on your browser, but if you delete or choose not to accept our cookies, you may be missing out on certain features of the Poochie Platform.  </Text>
                </Text>
                ...
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >
                    ...
                    <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                        We take reasonable measures to protect your information from unauthorized access, disclosure, or alteration. However, no method of data transmission or storage is completely secure, and we cannot guarantee its absolute security.  </Text>
                </Text>
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} >
                    Log File

                    <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                        Poochie follows a standard procedure of using log files. These files log visitors when they use the app. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the app, tracking users' movement on the app, and gathering demographic information.   </Text>
                </Text>
                <Text style={{ color: Colors.black, fontSize: 18, fontFamily: "Poppins-SemiBold" }} > Cookies


                    <Text style={{ color: Colors.black, fontSize: 16, fontFamily: "Poppins-Medium", marginHorizontal: 20 }} >
                        Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These are sent to your browser from the websites that you visit and are stored on your device's internal memory.     </Text>
                </Text>
